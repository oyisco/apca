...
var setWeekCalendar = function(settingElement, callback) {
    var startDate;
    var endDate;
...
var convertToWeekPicker = function(targetElement, fontAwesomeIcon, callback) {
    if (targetElement.prop("tagName") == "INPUT" && (targetElement.attr("type") == "text" || targetElement.attr("type") == "hidden")) {
        ...
        setWeekCalendar(targetElement, callback);
    } else {
